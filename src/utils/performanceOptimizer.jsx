// Enhanced Performance Optimization Utilities for VFXB MVP
import { lazy, Suspense } from 'react';

// Enhanced lazy loading with error boundaries and retry logic
export const createLazyComponent = (importFn, fallback = null, retryCount = 3) => {
...
export const createLazyRoute = (importFn, LoadingComponent = null) => {
  const LazyComponent = lazy(importFn);
  
  return (props) => (
    <Suspense fallback={LoadingComponent || <div className="flex items-center justify-center min-h-screen"><div className="animate-spin rounded-full h-12 w-12 border-b-2 border-blue-600"></div></div>}>
      <LazyComponent {...props} />
    </Suspense>
  );
};
