...
const Dashboard = () => {
  ...
  const { uploadVideo, videos, setVideos, currentVideo } = useVideo();
  const { setCurrentVideo } = useVideoStore(); // Get setCurrentVideo from the store directly
  ...
  useEffect(() => {
    // Clear upload state when returning to dashboard
    setUploadComplete(false);
    setUploadProgress(0);
    setIsUploading(false);
    setAiInsights([]);
    setCurrentVideo(null); // Clear the current video from the store
  }, [setCurrentVideo]); // Run when component mounts
  ...
  const handleDeleteVideo = () => {
    ...
    setAiInsights([]);
    setCurrentVideo(null); // Clear the current video
  };
  ...
  const videoCategories = [
    {
      ...
      icon: Video,
      color: "bg-blue-500",
      description: "All your video projects",
    },
    {
      id: "social",
      name: "Social Media",
    ...
    },
    {
      ...
      icon: TrendingUp,
      color: "bg-green-500",
      description: "Promotional and brand content",
    },
    {
      id: "education",
      name: "Education",
    ...
    },
    {
      ...
      icon: Play,
      color: "bg-orange-500",
      description: "Creative and fun videos",
    },
    {
      id: "business",
      name: "Business",
      icon: BarChart3,
      color: "bg-indigo-500",
      description: "Corporate and professional content",
    },
  ];
  ...
  const enhancedProjects = [
    ...
    },
    {
      ...
      resolution: "4K",
      fps: 60,
      collaborators: [{ name: "Alex Rivera", avatar: "AR", role: "Co-editor" }],
      isShared: true,
      comments: 7,
    },
    {
              ...
              return (
                ...
                >
                  <div className="flex items-center justify-between">
                    ...
                    <div
                      className={`bg-${stat.color}-500/10 p-3 rounded-lg border border-${stat.color}-500/20 group-hover:scale-110 transition-transform`}
                    >
                      <IconComponent
              ...
              >
                      ...
                      <div className="p-6 sm:p-8 md:p-12 text-center space-y-6">
                        ...
                        <div>
                          ...
                          <p className="text-muted-foreground mb-4 text-base sm:text-lg">
                            Drag and drop your video files here, or click to
                            browse
                          </p>
                ...
                >
                  <motion.button
                    ...
                    disabled={!uploadComplete || !currentVideo}
                  ...
                  <div className="bg-card/80 backdrop-blur-sm border border-border/50 rounded-xl p-6 shadow-elevation-2">
                    ...
                    {isAnalyzing ? (
                          ...
                          return (
                            ...
                            >
                              <div className="flex items-start space-x-3">
                                <div
                                  className={`${insight.bgColor} p-2 rounded-lg`}
                                >
                                  <IconComponent
                                    className={`w-4 h-4 ${insight.color}`}
                                  />
                                </div>
                                  ...
                                  <div className="flex items-center justify-between mt-2">
                                    <div className="flex items-center space-x-1">
                                      <div className="w-full bg-muted rounded-full h-1.5 max-w-[60px]">
                                        <div
                                          className={`h-1.5 rounded-full bg-gradient-to-r ${insight.color.replace(
                                            "text-",
                                            "from-"
                                          )} to-purple-500`}
                                          style={{
                      ...
                      <div className="text-center py-8">
                        ...
                        <p className="text-muted-foreground">
                          Upload a video to see AI insights
                        </p>
                      </div>
                    )}
                  </div>
                              ...
                              <span
                                className={`px-2 py-1 rounded-full text-xs font-medium backdrop-blur-sm ${
                                  project.status === "Completed"
                                    ? "bg-green-500/70 text-green-200 border-2 border-green-500/50 shadow-sm"
