...
class Video {
  constructor(videoData) {
    ...
    // Applied effects tracking for stacking
    this.appliedEffects = videoData.appliedEffects || [];

    // Parent video reference for effect chains
  ...
  async save() {
    try {
      ...
      const updatedVideo = await localStorageService.updateVideo(
        this._id,
        this.toObject()
      );
